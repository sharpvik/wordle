...
var $author$project$Main$rowOfLetters = A2(
	...
	5,
	A2(
		$author$project$Main$Letter,
		_Utils_chr('з'),
		$author$project$Main$Absent));
var $author$project$Main$initModel = {history: _List_Nil, letters: $author$project$Main$rowOfLetters, words: _List_Nil};
		...
		_List_fromArray(
			[
				...
				$elm$json$Json$Encode$string(
					$author$project$Main$typeToString(letter.ty))),
				_Utils_Tuple2(
				'rune',
				$elm$json$Json$Encode$string(
					$elm$core$String$fromChar(letter.rune)))
			]));
};
...
var $author$project$Main$getPossibleWords = function (_v0) {
	var letters = _v0.letters;
	return $elm$http$Http$request(
		{
			body: $elm$http$Http$jsonBody(
				$author$project$Main$lettersEncoder(letters)),
			expect: A2($elm$http$Http$expectJson, $author$project$Main$GotPatchResponse, $author$project$Main$possibleWordsDecoder),
			headers: _List_Nil,
			method: 'PATCH',
...
var $author$project$Main$restartTheGame = $elm$http$Http$request(
	{
		...
		expect: $elm$http$Http$expectWhatever($author$project$Main$Restarted),
		headers: _List_Nil,
		method: 'DELETE',
		timeout: $elm$core$Maybe$Nothing,
		tracker: $elm$core$Maybe$Nothing,
...
var $author$project$Main$Placed = {$: 'Placed'};
var $author$project$Main$Present = {$: 'Present'};
var $author$project$Main$nextType = function (ty) {
	switch (ty.$) {
		case 'Absent':
			return $author$project$Main$Present;
		case 'Present':
			return $author$project$Main$Placed;
		default:
			return $author$project$Main$Absent;
	}
};
var $author$project$Main$altLetter = function (letter) {
	return _Utils_update(
		letter,
		{
			ty: $author$project$Main$nextType(letter.ty)
		});
};
...
var $author$project$Main$updateAltLetter = F2(
	function (index, model) {
		return _Utils_update(
			model,
			{
				letters: A3($elm_community$array_extra$Array$Extra$update, index, $author$project$Main$altLetter, model.letters)
			});
	});
	...
	function (msg, model) {
		switch (msg.$) {
			case 'GotLetterInput':
				var index = msg.a;
				var contents = msg.b;
				var _v1 = $elm$core$String$uncons(contents);
				if (_v1.$ === 'Just') {
					var _v2 = _v1.a;
					var _char = _v2.a;
					return _Utils_Tuple2(
						A3($author$project$Main$updateLetter, index, _char, model),
...
var $author$project$Main$GotLetterAlt = function (a) {
	return {$: 'GotLetterAlt', a: a};
};
var $author$project$Main$GotLetterInput = F2(
	function (a, b) {
		return {$: 'GotLetterInput', a: a, b: b};
	});
...
var $author$project$Main$body = function (model) {
	...
	var letterInputBoxes = $elm$core$Array$toList(
		A2($elm$core$Array$indexedMap, letterInputBox, model.letters));
	var historyBox = function (letter) {
		return A2(
			$elm$html$Html$span,
			_List_fromArray(
				[
